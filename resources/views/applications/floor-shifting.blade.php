...
@section('title', 'Application For Floor Shifting | ' . config('app.name'))

@section('page-header', 'Application For Floor Shifting')

@section('dashboard-body')
    <div class="row">
        <form class="row g-3" action="{{ route('vs.store') }}" id="application" autocomplete="off" method="POST"
