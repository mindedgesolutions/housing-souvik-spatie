                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12 d-flex">
                                            ...
                                            <input type="text" name="captcha"
                                                class="form-control w-50 @error('captcha') is-invalid @enderror"
                                                placeholder="Please Enter Captcha" required>
                                        </div>
                                        ...
                                        <div
                                            class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center mt-2">
