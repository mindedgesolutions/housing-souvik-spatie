...
class NewApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'basic_pay_range' => 'required|numeric',
            ...
            'flat_type' => 'required',
            'allotment_reason' => 'required',
            'first_preference' => 'required',
    ...
    public function attributes()
    {
        return [
            ...
            'basic_pay_range' => 'basic pay range',
            'basic_pay' => 'basic pay',
    ...
    public function messages()
    {
        return [
            ...
            'doc_payslip.mimes' => 'Only .pdf files are allowed',
            'doc_payslip.size' => 'Max. file size 1 MB',
            'doc_signature.mimes' => 'Only .jpg, .jpeg, .png, .webp files are allowed',
            'doc_signature.size' => 'Max. file size 50 KB',
            'doc_signature.dimensions' => 'Dimension must be 140px / 60px',
        ];
    }
}
