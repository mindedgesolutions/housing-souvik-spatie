...
use App\Http\Requests\AllotmentApplication\CategoryShiftRequest;
...
class CategoryShiftingController extends Controller
{
    public function create()
    {
        ...
        return view('applications.category-shifting', compact(
            'hrms_data',
            'hrmsDob',
            'hrmsDoj',
            'hrmsDor',
    ...
    public function store(CategoryShiftRequest $request)
    {
        dd($request->all());
    }
}
